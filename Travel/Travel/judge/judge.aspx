      ...
      <div class="yi">
              <div class="leftbox">
               ...
               <div class="centerbox"> <!--产品介绍-->
                  <div> <h3  class="de"><a href="">【上海-台湾】台湾环岛7晚8日经典跟团游
        ...
        <!--表二-->
               <div class="downbox">
                   ...
                   <div>
                    <div class="e">
                          <div class="j1"><div class="tx1">评价商品</div></div>
                          <div class="j2"><div class="tx2">评价服务</div></div>
                          <div class="j3"><div class="tx3">晒图片</div><div class="l">
                          <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">
                          <img src="images/hgy.jpg" class="small" /></a></div></div>
                     </div>
                  ...
                  <div><a href="www.baidu.com" class="submit"><input type="submit" value="提交评价"/></a></div>
             </div>
       ...
       <!--表三-->
             ...
             <div class="boxthree"> 
                 ...
                 <div class="c"><input type="range" value="按默认"/>按默认</div>
